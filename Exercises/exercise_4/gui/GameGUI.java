...
public class GameGUI extends Application {
	...
	private Button delete_text = new Button("Delete all text"); // Defining delete button
...
*/
		...
		pane.getChildren().add(delete_text); // put delete button on GUI

		delete_text.setOnAction(e -> output.setText(null)); // making delete algorithm
